...
AUTH_USER = os.environ.get('AUTH_USERS', '5323404314').split(',')
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="@N13_shem")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="@N13_shem"),
            InlineKeyboardButton(text="🛠️ Help", url="@N13_shem"),
        ],
    ]
)
...
async def start_command(bot: Client, message: Message):
    ...
    caption = (
        ...
        "├─ Videos in various qualities\n"
        "├─ PDF files\n"
        "├─ Text files\n"
        "└─ ZIP archives\n\n"
        "📚 For detailed guide, use /help\n\n"
        "👤 Powered by: @N13_shem"
    )
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text=(
        ...
        "➥ /remauth xxxx – Remove User ID\n"
        "➥ /users – Total User List\n"
        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "📁 𝐂𝐡𝐚𝐧𝐧𝐞𝐥𝐬: **(Auth Users)**\n\n"
        "➥ /addchnl -100xxxx – Add\n"
        "➥ /remchnl -100xxxx – Remove\n"
        "➥ /channels – List - (OWNER)\n"
        "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
        "💡 𝗡𝗼𝘁𝗲:\n\n"
...
async def txt_handler(bot: Client, m: Message):  
    ...
    try:
        for i in range(arg-1, len(links)):
           ...
           try:
                cc = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]═╗\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**🎞️ Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║               мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shem_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                cc1 = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]═╗\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**📁 Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║               мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shen_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                cczip = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]═╗\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**📁 Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║               мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shem_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                ccimg = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**🖼️ Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║               мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shem_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                ccm = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]═╗\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**🎵 Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║              мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shem_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                cchtml = f'╔═[ 𝗧𝗘𝗔𝗠 𝗗𝗢𝗕𝗪𝗔𝗟 ]═╗\n[     ——— ✦ {str(count).zfill(3)} ✦ ———]({link0})\n\n**🌐 Title :** `{name1}`\n\n**📚 Course :** {b_name}\n\n**🌟 Extracted By :** {CR}\n\n╔════════════════════╗\n║              мιтσ¢нσи∂яια                  \n║ Join Backup <a href="t.me/shem_2_u">👉🏻JOIN NOW👈🏻</a> \n╚════════════════════╝'
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [мιтσ¢нσи∂яια](t.me/N13_shem)"
